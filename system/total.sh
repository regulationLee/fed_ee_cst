...
nohup python -u main.py -t 3 -ab 1 -lr 0.01 -jr 1 -lbs 10 -ls 1 -nc 20 -ncl 100 -data Cifar100 -m HtFE-img-8 -fd 512 -did 3 -algo FedGH -slr 0.01 -se 1 > total-Cifar100-HtFE-img-8-fd=512-FedGH.out 2>&1 &
nohup python -u main.py -t 3 -ab 1 -lr 0.01 -jr 1 -lbs 10 -ls 1 -nc 20 -ncl 100 -data Cifar100 -m HtFE-img-8 -fd 512 -did 4 -algo FedTGP -lam 10 -se 100 -mart 100 > total-Cifar100-HtFE-img-8-fd=512-FedTGP.out 2>&1 &
nohup python -u main.py -t 3 -ab 1 -lr 0.01 -jr 1 -lbs 10 -ls 1 -nc 20 -ncl 100 -data Cifar100 -m HtFE-img-8 -fd 512 -did 5 -algo FedKTL-stylegan-xl -slr 0.01 -sbs 100 -se 100 -lam 1 -mu 50 > total-Cifar100-HtFE-img-8-fd=512-FedKTL-stylegan-xl.out 2>&1 &
